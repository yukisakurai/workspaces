...
double TestSignificance ( TString infile = "hh_cp_12_combination_125.root",
  ...
  ProofConfig pc(*w, 1e2, "workers=3", false);
  ...
  TH1F *hCalcResult = new TH1F("CalcResult","CalcResult",5,0.0,5.0);
  hCalcResult->GetXaxis()->SetBinLabel(1,"NullPValue");
  hCalcResult->SetBinContent(1,CalcResult->NullPValue());
  hCalcResult->SetBinError(1,CalcResult->NullPValueError());

  hCalcResult->GetXaxis()->SetBinLabel(2,"Significance");
  hCalcResult->SetBinContent(2,CalcResult->Significance());
  hCalcResult->SetBinError(2,CalcResult->SignificanceError());

  hCalcResult->GetXaxis()->SetBinLabel(3,"CL_{b}");
  hCalcResult->SetBinContent(3,CalcResult->CLb());
  hCalcResult->SetBinError(3,CalcResult->CLbError());

  hCalcResult->GetXaxis()->SetBinLabel(4,"CL_{s+b}");
  hCalcResult->SetBinContent(4,CalcResult->CLsplusb());
  hCalcResult->SetBinError(4,CalcResult->CLsplusbError());

  hCalcResult->GetXaxis()->SetBinLabel(5,"CL_{s}");
  hCalcResult->SetBinContent(5,CalcResult->CLs());
  hCalcResult->SetBinError(5,CalcResult->CLsError());


  TDatime time;
  TString fname = "TestSignificance_";
  fname += time.GetDate();
  fname += time.GetTime();
  fname += ".root";
